...
class InstallProfileTests(unittest.TestCase):
    ...
    def test_universal_image_contains_dual_wifi_and_profile_settings(self):
        ...
        self.assertIn("hidden=true", builder)
    ...
    def test_profile_branding_and_hdmi_fallbacks_are_installed(self):
        ...
        self.assertIn('not token.startswith(("video=HDMI-A-1:", "video=HDMI-A-2:"))', setup)
        self.assertNotIn('tokens.extend(("video=HDMI-A-1:3840x2160@30D", "video=HDMI-A-2:3840x2160@30D"))', setup)
    ...
    def test_firstboot_explicitly_tries_both_wifi_profiles_without_wizard(self):
        ...
        self.assertIn("802-11-wireless.hidden yes", (ROOT / "install.sh").read_text(encoding="utf-8"))
